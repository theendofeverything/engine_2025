...
class Matrix2DH:
    ...
    def inv(self) -> Matrix2DH:
        ...
        Note: I only defined self.adj for inspection, I do not use it in my calculation of the
        inverse.

        Using self.adj to calculate self.inv adds three unnecessary calculations: the third row of
        self.inv, which is always (0, 0, 1). In particular, calculating self.inv entry m33 opens the
        possibility of floating-point error. In the adjugate, m33 is the determinant of the matrix.
        Dividing the adjugate m33 by the determinant always equals 1, except when there is floating
        point error.
        """
